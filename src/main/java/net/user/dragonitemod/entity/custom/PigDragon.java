...
public class PigDragon extends Animal {
    public PigDragon(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob ageableMob) {
        return ModEntities.PIGDRAGON.get().create(pLevel);
    }
